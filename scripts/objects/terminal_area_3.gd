...
func liberar_terminal_do_quiz():
	documento_lido = true
	print("Sinal recebido! Terminal da Fase 3 liberado.")

func mostrar_aviso_bloqueio():
	aviso_terminal.text = "ACESSO NEGADO!\nVasculhe as caixas do laboratório para encontrar o documento de acesso."
	aviso_terminal.visible = true
...
func _on_botao_opcao_2_pressed():
	print("Resposta Correta! Quiz da Fase 3 vencido.")
...
func resposta_errada():
	...
	aviso_terminal.text = "RESPOSTA INCORRETA!\nVasculhe as caixas novamente para reler o documento antes de tentar de novo."
	aviso_terminal.visible = true
